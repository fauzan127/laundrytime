<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                <x-text-input id="password" class="block mt-1 w-full pr-10"
                              type="password"
                              name="password"
                              minlength="8" placeholder="minimal 8 karakter" required autocomplete="new-password" />
        ...
        <a href="{{ route('google.login') }}"
           class="bg-gray-300 flex items-center justify-center w-full rounded-lg py-2 hover:bg-gray-400 transition">
